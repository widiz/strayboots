window.translate = {
	...
	"You got 1 last try! Would you like to take a hint?": "محاولتكم التالية هي الأخيرة ! ، أترغبون بتلميحة؟ ",
	"Yes": "نعم",
	"No": "لا",
	"days": "أيام",
	"Skip": "تخطي",
	...
	"Are you sure you want to skip? There's no way back...": "متأكدون من رغبتكم تخطي هذا اللغز؟  لن يمكنكم العودة اليه مجددا",
	"Using a HINT will deduct half of the points. Are you sure?": "متأكدون؟ سيؤدي استخدامكم التلميحة لخصم نصف النقاط لهذا اللغز... ",
	"We just successfully finished our Strayboots scavenger hunt!": "لقد انتهينا بنجاح من لعبة للبحث عن الكنز!",
	"Strayboots Scavenger Hunts": "لعبة Strayboots  للبحث عن الكنز",
	"That was so much fun!!! #teambuilding #scavengerhunt @strayboots": "كان أمراً ممتعاً للغاية!!! #تكوين الفريق #لعبةالبحث عن الكنز @strayboots كانت مغامرةً ممتعةً للغاية! #بناء_الفُرُق...",
