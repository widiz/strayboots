...
class ParamsParser extends Component{
  ...
  public function setPage() {
    $this->page = $this->params['length'] < 1 ? 1 : (int)(floor($this->params['start'] / $this->params['length']) + 1);
  }
  ...
  public function getLimit($total = PHP_INT_MAX) {
    return $this->params['length'] < 1 ? $total : $this->params['length'];
  }
