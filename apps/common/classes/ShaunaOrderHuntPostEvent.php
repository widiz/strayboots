...
class ShaunaOrderHuntPostEvent extends OrderHuntMailBase {
	...
	public function __construct(OrderHunts $orderHunt, bool $toPlayers = false)
	{
		...
		$this->title = $translate->_('What if you could motivate your employees with ONE word...');
		...
		$this->text = $translate->_('ShaunaOrderHuntPostEventText', [
			'url' => $eurl
		]);
		$this->html = $translate->_('ShaunaOrderHuntPostEventHTML', [
			'url' => $eurl
		]);
