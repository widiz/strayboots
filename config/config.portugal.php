...
define('SB_PREFIX', 'sbpt:');
define('FB_PREFIX', 'portugal/');
return new \Phalcon\Config([
	'prefix' => 'portugal',
	'altLang' => ['he', 'pt'],
	'defLang' => 2,
	'fullUri' => 'http://pt.strayboots.com',
	'database' => [
		'adapter'	=> 'Mysql',
		'host'		=> 'mysql.go.strayboots.com',
		'username'	=> 'portugal',
		'password'	=> 'mj6RJl9x7xhf40cv',
		'dbname'	=> 'portugal',
	...
	'application' => [
		...
		'tmpDir'			=> APP_PATH . '/apps/common/tmp/pt/',
		'frontUploadsDir'	=> [
			'path'	=> APP_PATH . '/apps/frontend/uploads/pt/',
			'uri'	=> '/uploads/pt/'
		],
		'clientsUploadsDir'	=> [
			'path'	=> APP_PATH . '/apps/clients/uploads/pt/',
			'uri'	=> '/cu/pt/'
		],
		'suppliersUploadsDir'	=> [
