<?php
define('SB_PRODUCTION', false);
define('SB_PREFIX', 'sbs:');
define('FB_PREFIX', 'staging/');
return new \Phalcon\Config([
	'prefix' => 'staging',
	'altLang' => ['he', 'pt'],
	'defLang' => 0,
	'fullUri' => 'http://staging.strayboots.com',
	'database' => [
		'adapter'	=> 'Mysql',
	...
	'application' => [
		...
		'tmpDir'			=> APP_PATH . '/apps/common/tmp/s/',
		'frontUploadsDir'	=> [
			'path'	=> APP_PATH . '/apps/frontend/uploads/s/',
			'uri'	=> '/uploads/s/'
		],
		'clientsUploadsDir'	=> [
			'path'	=> APP_PATH . '/apps/clients/uploads/s/',
			'uri'	=> '/cu/s/'
		],
		'suppliersUploadsDir'	=> [
			'path'	=> APP_PATH . '/apps/suppliers/uploads/s/',
			'uri'	=> '/su/s/'
		],
		'baseUri'			=> '/'
	],
